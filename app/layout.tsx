    ...
    <html lang="en">
      ...
      <body className={inter.className}>
        ...
        <div className="relative">
          <div className="absolute -z-10 bg-gray-50 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px] h-full w-full" />
          <Navbar />
          {children}
        </div>
        <Toaster />
